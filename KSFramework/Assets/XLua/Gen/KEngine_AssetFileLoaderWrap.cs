...
namespace XLua.CSObjectWrap
{
    ...
    public class KEngineAssetFileLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "IsBundleResourceExist", _m_IsBundleResourceExist_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsBundleResourceExist_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = KEngine.AssetFileLoader.IsBundleResourceExist( _url );
