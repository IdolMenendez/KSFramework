...
namespace XLua.CSObjectWrap
{
    ...
    public class KEngineLogWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 22, 3, 3);
        ...
        static int _m_GetMonoUseMemory_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = KEngine.Log.GetMonoUseMemory(  );
        ...
        static int _m_LogToFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _szMsg = LuaAPI.lua_tostring(L, 1);
                    bool _append = LuaAPI.lua_toboolean(L, 2);
                    
                    KEngine.Log.LogToFile( _szMsg, _append );
                ...
                if(gen_param_count >= 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 2) || translator.Assignable<object>(L, 2))) 
                {
                    ...
                    KEngine.Log.LogToFile( _szMsg, _args );
